...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Deletar'), array('action' => 'delete', $this->Form->value('Empresa.empcodigo')), null, __('Deseja excluir# %s?', $this->Form->value('Empresa.empcodigo'))); ?></li>
